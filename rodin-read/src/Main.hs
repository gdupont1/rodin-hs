...
printHelp = do
    ...
    putStrLn "Each file of the given list is processed independently. The program automatically"
    putStrLn "determines the correct way to process the file based on its extension."
    putStrLn "The transformed file is <file>.tex or .ascii (including original extension)."
    putStrLn ""
